  ...
  return (
    <div className={`min-h-screen flex flex-col ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-800'}`}>
      ...
      <button
        ...
        className="fixed top-4 right-4 bg-gray-200 text-black dark:bg-gray-800 dark:text-white p-2 rounded-md shadow-md hover:shadow-lg"
      >
      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-start lg:justify-between w-full max-w-6xl px-6 lg:px-0 py-8">
        ...
        <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-md rounded-lg p-6 w-full max-w-md mr-7`}>
          <div>
            <input
              className={`my-3 w-full border ${darkMode ? 'border-gray-600 bg-gray-700 text-white' : 'border-gray-300'} p-3 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500`}
              type="text"
